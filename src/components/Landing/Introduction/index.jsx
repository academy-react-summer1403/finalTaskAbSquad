...
const Introduction = () => {
  return (
    <>
      <h1 className="text-5xl text-center line leading-normal mb-4 max-sm:text-3xl">
        تجربه ای بی نظیر در یادگیری
        {/* The Curly Brace Span */}
        <span className="lg:shadow-lg lg:inline-block lg:relative lg:top-4 lg:right-1 lg:rounded-full lg:w-14 lg:h-14 hidden">
